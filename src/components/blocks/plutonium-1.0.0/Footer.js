...
export default function Footer() {
  ...
  return (
    <footer className="text-black dark:text-gray-300 body-font">
      <div className="container flex flex-col items-center px-10 mx-auto border-t border-purple-600 dark:border-purple-300 sm:flex-row">
        <Link href="/">
        ...
        <p className="text-center pb-8"> &copy; 2026 All rights reserved by <a href="https://github.com/minor" className="font-semibold text-green-500" target="_blank" rel="noopener noreferrer">Saurish</a> • Distributed by <a href="https://themewagon.com" className="font-semibold text-green-500" target="_blank" rel="noopener noreferrer">ThemeWagon</a> </p>
        </footer>
  );
}
